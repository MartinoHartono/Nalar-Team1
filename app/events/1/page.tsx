    ...
    return (
        <div>
            ...
            <div className="flex flex-col pl-7.25 bg-[tomato]">
                ...
                <ul className="inline-flex mt-7.25 gap-4 items-center">
                    <li className="flex py-2 px-3 flex-col justify-center items-center gap-1.5 rounded-2xl bg-(--primary-subtle) label-small text-(--primary)">Label</li>
                    <li className="flex py-2 px-3 flex-col justify-center items-center gap-1.5 rounded-2xl bg-(--primary-subtle) label-small text-(--primary)">Label</li>
                    <li className="flex py-2 px-3 flex-col justify-center items-center gap-1.5 rounded-2xl bg-(--primary-subtle) label-small text-(--primary)">Label</li>
                </ul>

                <div className="flex flex-col w-[355px] mt-3.25 items-start gap-2">
                    <p className="font-judul">Harga</p>
                    <div className="flex py-2 px-3 flex-col justify-center items-center rounded-2xl bg-(--primary-subtle)">
                        <p className="label-small text-(--primary)">Label</p>
                    </div>
                </div>

                <div className="flex w-[355px] mt-4.5 flex-col items-start gap-1.25">
                    <p className="font-judul">Timeline</p>
                    <div className="flex items-center gap-2.5 self-stretch">
                        <div className="flex flex-col justify-center items-end gap-2">
                            {/* <div className="flex w-px h-[103px] left-5 top-4 bg-[rgba(186, 186, 186, 0.17)]"></div> */}
                            <div className="w-10 h-10 aspect-square">
                                <svg
                                    ...
                                    fill="none"
                                >
                                    <circle cx={20} cy={20} r={9} fill="#3A00E5" />
                                </svg>
                            ...
                            <div className="w-10 h-10 aspect-square">
                                <svg
                                    ...
                                    fill="none"
                                >
                                    <circle cx="20.5" cy="19.5" r="4.5" fill="#BABABA" fillOpacity="0.17" />
                                </svg>
                        ...
                        <div>
                            <div className="flex w-[305px] flex-col justify-center items-start gap-2 flex-[1_0_0]">
                                <div className="flex py-2.5 px-4 flex-col justify-center items-center gap-1.5 self-stretch rounded-lg border border-solid border-(--primary) bg-(--primary-subtle)">
                                    <p className="label-medium text-(--primary)">Label</p>
                                </div>
                                <div className="flex py-2.5 px-4 flex-col justify-center items-center gap-1.5 self-stretch rounded-lg bg-(--primary-subtle)">
                                    <p className="label-medium text-(--primary)">Label</p>
                                </div>
                                <div className="flex py-2.5 px-4 flex-col justify-center items-center gap-1.5 self-stretch rounded-lg bg-(--primary-subtle)">
                                    <p className="label-medium text-(--primary)">Label</p>
                ...
                <div className="flex w-[355px] mt-[15px] flex-col items-start gap-1.25">
                    <p className="font-judul">Deskripsi</p>
                    <p className="font-informasi">
                        Lorem ipsum dolor sit amet consectetur. Ut et tortor in amet eu. Nisi in egestas natoque accumsan justo. Pulvinar ornare at penatibus enim elementum aliquet cras. Sed ultricies eu nec odio velit tempus. Tempor quam eget maecenas ultricies commodo quis. Nulla pellentesque tempus quis turpis arcu rhoncus. Mi massa lectus fermentum vestibulum sed urna in volutpat.
                    </p>
                </div>
            </div>
